...
/*   Updated: 2023/07/24 14:01:23 by lde-cast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	path_image(char *path[ENEMY_FOUR + 1])
{
	...
	*(path + ENEMY_FIVE - 1) = "img/sprite/mage5.xpm";
	*(path + ENEMY_SIX - 1) = "img/sprite/mage6.xpm";
	*(path + ENEMY_SEVEN - 1) = "img/sprite/mage7.xpm";
	*(path + ENEMY_EIGHT - 1) = "img/sprite/mage8.xpm";
}

static t_status	image_load(t_place *set)
{
	char		*path[ENEMY_EIGHT + 1];
	int			i;
